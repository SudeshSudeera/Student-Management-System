...
public class ProgramBoImpl implements ProgramBo {
    ...
    public void saveProgram(ProgramDto dto) throws SQLException, ClassNotFoundException {
        // MapStruct, modelmapper => They used for this // but here normal method used
    ...
    public List<CustomRegistrationData> findAllRegistrations() {
        ...
        for (Registration temp:programDao.findllRegistrations()) {
            data.add(new CustomRegistrationData(
                    temp.getRegDate(),
